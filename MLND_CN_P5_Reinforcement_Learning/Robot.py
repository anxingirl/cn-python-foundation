...
class Robot(object):
    ...
    def update_Qtable(self, r, action, next_state):
        ...
        if self.learning:
            ...
            #action_ = max(self.Qtable[next_state], key=self.Qtable[next_state].get)
            #self.Qtable[self.state][action]=(1-self.alpha)*self.Qtable[self.state][action]+self.alpha*(r+self.gamma*self.Qtable[next_state][action_])
